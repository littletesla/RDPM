def RDGM(X, num_mach, lam, delta, tau):
    ...
    # Class for iterative gradient calculations
    class Caculates:
        ...
        # Soft-thresholding function for regularization
        ...
        # Gradient update step with Nesterov acceleration
    ...
    # Function to compute robust scale estimator Qn
    def Qn(x, d=1):
        n = len(x)
        x_1d = x.reshape(n)
        x = x_1d.tolist()
    ...
    # Loop through columns for estimation
    for column in range(p-1):
        ...
        # Define chunk sizes for different machine counts
        if num_mach == 5:
