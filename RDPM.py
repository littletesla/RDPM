...
if __name__ == "__main__":
    ...
    n = 200 ; p = 200; mach_num = 5 # m = 5,10,15,20,25
    ...
    max = np.max(np.abs(Theta_true - Theta))

    print('frob is', frob)
    print('spectral is', spectral)
    print('max is', max)
    print(Theta.round(3))
    # x1_data = list(range(len(error_record)))
    # y1_data = error_record
    # plt.plot(x1_data, y1_data, 'r--',marker='o', markevery=100)
